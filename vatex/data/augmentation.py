...
class ResizeShortestEdge(T.Augmentation):
    ...
    def get_transform(self, image):
        ...
        neww = int(neww + 0.5)
        newh = int(newh + 0.5)
        # return T.ResizeTransform(h, w, 480, 480, self.interp)
...
def build_augmentation(cfg, is_train):
    ...
    if is_train:
        ...
        sample_style = "choice"
        aug_list.append(ResizeShortestEdge(min_size, max_size, sample_style))
        # aug_list.append(T.ResizeTransform(min_size, max_size, sample_style))
    return aug_list
